...
import 'package:prescriotion/layout/prescription_layout.dart';
            ...
            return SizedBox(
              ...
              child: myButton(
                onPressed: () {
                  ...
                  navigateTo(context, PrescriptionScreen(
                    patientEmail: patientEmail,
                    doctorName:DoctorCubit.get(context).oldPrescriptions[index]['doctor_name'] ,
                    pDate:DoctorCubit.get(context).oldPrescriptions[index]['created_at'] ,
                    pDetails:DoctorCubit.get(context).oldPrescriptions[index]['details'] ,
                  ));
                },
                color: Colors.white,
                elevation: 4,
                ...
                child: Text(
                  "${DoctorCubit
                      .get(context)
                      .oldPrescriptions[index]['doctor_name'] + DoctorCubit
                      .get(context)
                      .oldPrescriptions[index]['created_at']}",
                  // 'next',
